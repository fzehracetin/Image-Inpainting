...
if __name__ == "__main__":
    ...
    print imageFile
    maskFile = cfg.MASK_FOLDER + sys.argv[2]
    main(imageFile, maskFile)'''

    maskFile = cfg.MASK_FOLDER + "mask2.jpg"
    for filename in os.listdir(cfg.SRC_FOLDER):
        print(filename)
        imageFile = cfg.SRC_FOLDER + filename
        cfg.IMAGE = filename.split('.')[0]
        main(imageFile, maskFile)
